...
def generate_client_id(device_id):
    return "IOT_client-SSPMS-Id" + device_id + '-' + str(r)
...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self, mc):
        ...
        formLayot.addRow("Chlorine (ppm)", self.Chlorine)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Swimming Pool Water Quality')
    ...
    def update_data(self):
        ...
        chlorine_level = display_number(base_chlorine + random.randrange(0, 8))
        ...
        temperature_level = display_number(base_temperature + random.randrange(3, 12))
        ...
        message = {"chlorine": float(chlorine_level), "turbidity": float(turbidity_level), "temperature": float(temperature_level),
                   "ph": float(ph_level),
    ...
    def send_alarms_if_needed(self, message):
        validation_func_map = {"chlorine": self.should_alarm_chlorine, "turbidity": self.should_alarm_turbidity, "temperature": self.should_alarm_temperature,
    ...
    def should_alarm_chlorine(self, value):
        return value > chlorine_max or value < chlorine_min
    ...
    def should_alarm_temperature(self, value):
        return value > temperature_max or value < temperature_min
